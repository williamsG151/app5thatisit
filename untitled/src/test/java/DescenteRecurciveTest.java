...
public class DescenteRecurciveTest {
    ...
    @Test
    public void test3(){
        Assert.assertTrue(testwriter("testS3.txt","4*(2+ &)"));
    }
    @Test
    public void test4(){
        Assert.assertTrue(testwriter("testS4.txt","Abcde + Cewf_"));
    }
    @Test
    public void test5(){
        Assert.assertFalse(testwriter("testS5.txt","Ab_cde + Cewf"));
    }
    @Test
    public void test6(){
    ...
    @Test
    public void test7(){
        Assert.assertFalse(testwriter("testS7.txt","3 + Cewf"));
    }
    @Test
    public void test8(){
        Assert.assertFalse(testwriter("testS8.txt","(V_y + V_X)"));
    }
    @Test
    public void test9(){
